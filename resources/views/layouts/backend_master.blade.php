...
<div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <!-- Nav Item - Customer Request -->
<li class="nav-item">
    <a class="nav-link" href="{{route('book_request')}}">
...
<li class="nav-item">
    ...
    <div id="collapseBooks" class="collapse" aria-labelledby="headingBooks"
         data-parent="#accordionSidebar">
        <div class="bg-white py-2 collapse-inner rounded">
            <a class="collapse-item" href="{{route('backend.book.create')}}">Create</a>
            <a class="collapse-item" href="{{route('backend.book.index')}}">List</a>
        </div>
    </div>
</li>
...
<li class="nav-item">
    ...
    <div id="collapseHelp" class="collapse" aria-labelledby="headingHelp"
         data-parent="#accordionSidebar">
        <div class="bg-white py-2 collapse-inner rounded">
            <a class="collapse-item" href="{{url('backend/help_user')}}">Help</a>
        </div>
    </div>
</li>
