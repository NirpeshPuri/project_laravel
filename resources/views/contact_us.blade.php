...
assist you. Do send us feedbacks if you have any!
			...
			<form class="form-inline row contactform" method="post" accept="https://www.ektabooks.com/contact" data-parsely-validate>
				<input type="hidden" name="_token" value="GOPCPPVDyZWtnFz8t6ORmlxAkqgS3fCEOSpzGdsS">
